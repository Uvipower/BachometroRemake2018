  ...
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="modalDetalles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Anexar información extra al reporte</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form id="reporteDetalles" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="form-group">
                <label for="imagen">Cargar fotografia del bache</label>
                <input type="file" class="form-control-file" name="imagen" id="imagen" accept="image/x-png,image/jpeg">
              </div>
              <div class="form-group">
                <label for="descripcion">Descripción del bache</label>
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
            <button class="btn btn-primary" id="registrarBache" type="button">Registrar bache</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="../js/Lobibox/lobibox.js"></script>
